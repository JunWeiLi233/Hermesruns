import{r as m}from"./I18nContext-4KO4owZi.js";var d="hermes_assigned_coach_v1",s=[{id:"mara-voss",name:"Mara Voss",roleEn:"Endurance Head Coach",roleZh:"耐力主教练"},{id:"elias-brooks",name:"Elias Brooks",roleEn:"Race Strategy Coach",roleZh:"比赛策略教练"},{id:"naomi-vale",name:"Naomi Vale",roleEn:"Performance Coach",roleZh:"表现教练"},{id:"lucas-rye",name:"Lucas Rye",roleEn:"Training Block Coach",roleZh:"训练周期教练"}];function f(e){let t=0;for(let a=0;a<e.length;a+=1)t=(t<<5)-t+e.charCodeAt(a),t|=0;return Math.abs(t)}function g(){try{const e=window.localStorage.getItem(d);if(!e)return{};const t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function u(e){try{window.localStorage.setItem(d,JSON.stringify(e))}catch{}}function y(e,t){const a=e?.id!=null?String(e.id):"",r=e?.email?String(e.email).trim().toLowerCase():"",i=t?String(t).trim().toLowerCase():"",o=e?.displayName?String(e.displayName).trim():"";return a||r||i||o||"hermes-runner"}function x(e,t){const a=y(e,t),r=g(),i=r[a],o=s.find(h=>h.id===i);if(o)return o;const c=s[f(a)%s.length];return u({...r,[a]:c.id}),c}function C(e,t){return e?t==="zh-CN"?e.roleZh:e.roleEn:""}var n=m(),l=[{start:"#f6c8b8",end:"#d96b57",jacket:"#7b3226"},{start:"#d7e7f6",end:"#7ea6cf",jacket:"#2f4d6d"},{start:"#d8eddc",end:"#7cb588",jacket:"#305a3d"},{start:"#f0dff8",end:"#b88ad3",jacket:"#5c3675"}];function b(e){return Array.from(String(e||"")).reduce((t,a)=>t*31+a.charCodeAt(0)>>>0,0)}function v(e){const t=l[b(e)%l.length],a=`
...
//# sourceMappingURL=CoachIdentityBadge-B8wdfvAU.js.map