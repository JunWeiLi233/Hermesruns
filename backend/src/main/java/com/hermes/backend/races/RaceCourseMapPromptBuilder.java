...
public class RaceCourseMapPromptBuilder {
    ...
    public String buildPlausibilityRescuePrompt(
        ...
        String routeShapeHint = raceType == PromptRaceType.POINT_TO_POINT
    ...
    public int minimumRoutePointCountForRescue(PromptRaceType raceType) {
        return 12;
    }
}
