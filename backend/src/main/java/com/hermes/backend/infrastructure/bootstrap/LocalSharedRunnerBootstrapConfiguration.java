package com.hermes.backend.infrastructure.bootstrap;
...
public class LocalSharedRunnerBootstrapConfiguration {
    ...
    @Value("${app.local-shared-runner.email:#{T(com.hermes.backend.infrastructure.bootstrap.LocalSharedRunnerBootstrapService).DEFAULT_EMAIL}}")
    private String email;

    @Value("${app.local-shared-runner.password:}")
    private String password;

    @Value("${app.local-shared-runner.strava-athlete-id:#{T(com.hermes.backend.infrastructure.bootstrap.LocalSharedRunnerBootstrapService).DEFAULT_STRAVA_ATHLETE_ID}}")
