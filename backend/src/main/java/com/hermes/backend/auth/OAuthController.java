...
public class OAuthController {
    ...
    public OAuthController(RunnerRepository runnerRepository, AuthService authService,
        ...
        this(runnerRepository, authService, activityRepository, secretEncryptionService,
                aiUsageService, new OAuthProviderClient(restTemplate), systemConfigService, stravaTokenService,
    ...
    public RedirectView handleGoogleCallback(
        ...
        try {
            Map<String, Object> tokenBody = oauthProviderClient.exchangeGoogleCode(
            ...
            Map<String, Object> infoBody = oauthProviderClient.googleUserInfo(accessToken);
    ...
    public RedirectView handleStravaCallback(
        ...
        try {
            Map<String, Object> responseBody = oauthProviderClient.exchangeStravaCode(
                    code, effectiveStravaClientId(), effectiveStravaClientSecret(), effectiveStravaRedirectUri());
