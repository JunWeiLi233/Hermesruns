...
public final class ActivityTypeResolver {
    private ActivityTypeResolver() {
    }

    public static ActivityType fromSportLabels(String... rawLabels) {
    ...
    public static ActivityType inferStoredActivityType(Activity activity) {
        if (activity == null) {
