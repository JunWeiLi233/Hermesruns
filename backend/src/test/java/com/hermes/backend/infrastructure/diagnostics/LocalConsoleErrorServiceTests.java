...
class LocalConsoleErrorServiceTests {
    ...
    void recordMergesDuplicateFingerprintsAndWritesLedgerFiles() throws Exception {
        ...
        Path jsonPath = workspaceRoot.resolve(".workspace/state/LOCAL_CONSOLE_ERRORS.json");
        Path markdownPath = workspaceRoot.resolve(".workspace/state/LOCAL_CONSOLE_ERRORS.md");
