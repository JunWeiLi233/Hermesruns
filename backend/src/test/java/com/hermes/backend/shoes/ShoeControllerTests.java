...
class ShoeControllerTests {
    ...
    private ShoeController controller(AuthService auth, ShoeRepository shoeRepo,
        ...
        return controller(auth, shoeRepo, actRepo, identSvc, mock(ShoeCatalogModelRepository.class));
    }
    ...
    private ShoeController controller(AuthService auth, ShoeRepository shoeRepo,
        ...
        ShoeInventoryService inventory = new ShoeInventoryService(shoeRepo, actRepo, identSvc, catalogRepo,
                tracker, mock(CoachScheduledWorkoutRepository.class), assets);
    ...
    void recommendationInfersTrailSurfaceFromTodaysScheduledWorkout() {
        ...
        ResponseEntity<?> resp = new ShoeController(
                auth,
                new ShoeInventoryService(shoeRepo, actRepo, identSvc, catalogRepo, shoeTracker, scheduleRepo,
                        new ShoeAdminAggregateService(identSvc, mock(ShoeImageAssetService.class)))
