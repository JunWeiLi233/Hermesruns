...
class StravaWebhookControllerTests {
    ...
    void validateSubscriptionRejectsWrongMode() {
        ...
        ResponseEntity<?> response = controller.validateSubscription("ping", "hermes-strava-webhook", "challenge-123");
    ...
    void validateSubscriptionReturnsHubChallengeForValidRequest() {
        ...
        ResponseEntity<?> response = controller.validateSubscription("subscribe", "hermes-strava-webhook", "challenge-123");
    ...
    private StravaWebhookController createController(RunnerRepository runnerRepository, OAuthController oAuthController) {
        ...
        ReflectionTestUtils.setField(controller, "verifyToken", "hermes-strava-webhook");
        return controller;
    }
