...
const DEFAULT_BRIEF_JSON = ".workspace/state/AUTO_HERMES_STRUCTURE_UPDATE.json";
const DEFAULT_BRIEF_MD = ".workspace/state/AUTO_HERMES_STRUCTURE_UPDATE.md";
...
function createControllerSteeringCandidate(rootDir) {
  ...
  return {
    ...
    files: [
      ...
      ".workspace/state/AUTO_HERMES_STRUCTURE_UPDATE.json",
    ],
