...
const SCREEN_INTENTS = [
  { screen: "TodayRun", tier: 1, intent: 'Answer "should I run today and how hard?"', file: "frontend/src/pages/today-run/TodayRun.jsx" },
  { screen: "Profile", tier: 1, intent: "Show trend and readiness at a glance", file: "frontend/src/pages/profile/Profile.jsx" },
  { screen: "Analysis", tier: 1, intent: "Deep-dive into training science", file: "frontend/src/pages/analysis/Analysis.jsx" },
  { screen: "Runs", tier: 2, intent: "Searchable, sortable log with pattern recognition", file: "frontend/src/pages/runs/Runs.jsx" },
  { screen: "RunDetail", tier: 2, intent: "Individual run breakdown and GPS route", file: "frontend/src/pages/runs/RunDetail.jsx" },
  { screen: "Shoes", tier: 1, intent: "Never get caught with dead shoe mid-block", file: "frontend/src/pages/shoes/Shoes.jsx" },
  { screen: "Races", tier: 3, intent: "Race day planning and goal-setting", file: "frontend/src/pages/races/Races.jsx" },
  { screen: "Rewards", tier: 4, intent: "Celebrate consistency without feeling cheap", file: "frontend/src/pages/rewards/Rewards.jsx" },
  { screen: "Settings", tier: 5, intent: "Control and trust - runner owns their data", file: "frontend/src/pages/settings/Settings.jsx" },
  { screen: "Landing", tier: 5, intent: "Convert a skeptical Strava user", file: "frontend/src/pages/landing/Landing.jsx", requiresEmptyState: false },
  { screen: "Login", tier: 5, intent: "Convert returning runners without friction", file: "frontend/src/pages/auth/Login.jsx", requiresEmptyState: false },
  { screen: "Signup", tier: 5, intent: "Onboard new runners with minimal friction", file: "frontend/src/pages/auth/Signup.jsx", requiresEmptyState: false },
  ...
  { screen: "Dashboard", tier: 5, intent: "Admin ops surface 鈥?race maps, course review, catalog", file: "frontend/src/pages/admin/Dashboard.jsx", requiresEmptyState: false },
  { screen: "Heatmap", tier: 3, intent: "Visualize where the runner trains geographically", file: "frontend/src/pages/heatmap/Heatmap.jsx" },
  { screen: "WeatherEngine", tier: 2, intent: "Show how weather affects today's target pace", file: "frontend/src/pages/weather/WeatherEngine.jsx" },
  { screen: "AnalysisInsightDetail", tier: 2, intent: "Drill into a single training insight with supporting data", file: "frontend/src/pages/analysis/AnalysisInsightDetail.jsx" },
  ...
  { screen: "AddShoes", tier: 1, intent: "Add new shoes with AI-assisted mileage detection", file: "frontend/src/pages/shoes/AddShoes.jsx" },
  { screen: "ShoeCatalog", tier: 5, intent: "Browse and select shoe models from the catalog", file: "frontend/src/pages/shoes/ShoeCatalog.jsx", requiresEmptyState: false },
  { screen: "RacesDetail", tier: 3, intent: "Race-day brief with course map and elevation", file: "frontend/src/pages/races/RacesDetail.jsx" },
  { screen: "Schedule", tier: 1, intent: "Weekly training plan with load and recovery view", file: "frontend/src/pages/schedule/Schedule.jsx" },
  { screen: "PredictionDetail", tier: 3, intent: "Show race-time prediction with confidence and methodology", file: "frontend/src/pages/prediction/PredictionDetail.jsx" },
  { screen: "MuscleTraining", tier: 2, intent: "Strength sessions that complement running load", file: "frontend/src/pages/muscle-training/MuscleTraining.jsx" },
  { screen: "LegalPage", tier: 5, intent: "Privacy and terms 鈥?builds trust with cautious runners", file: "frontend/src/pages/legal/LegalPage.jsx", requiresEmptyState: false },
  ...
  { screen: "ForgotPassword", tier: 5, intent: "Restore access and trust for existing runners", file: "frontend/src/pages/auth/ForgotPassword.jsx", requiresEmptyState: false },
];
...
function loadAgentSync() {
  const file = path.resolve(ROOT, ".workspace/state/AGENT_SYNC.json");
...
function discoverLocalConsoleErrors() {
  const ledgerPath = path.resolve(ROOT, '.workspace/state/LOCAL_CONSOLE_ERRORS.json');
  ...
  return entries
    ...
    .map((entry) => {
      ...
      return {
        ...
        files: [screenMeta?.file || 'frontend/src/main.jsx', '.workspace/state/LOCAL_CONSOLE_ERRORS.md'],
      };
    });
}
