...
//     persistent context directory under .workspace/state/playwright-state/<state>/,
...
const STATE_DIR_BASE = path.join(REPO_ROOT, ".workspace/state", "playwright-state");
...
function printHelp() {
  process.stdout.write([
    ...
    "  doctor",
    "",
    "Persistent context lives at .workspace/state/playwright-state/<state>/ so cookies",
