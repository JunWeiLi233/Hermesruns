...
## Scope
- Baseline prompt: `.tools\token_tester\prompts\codex_loop_without_savers.md`
- Optimized prompt: `.tools\token_tester\prompts\codex_loop_with_savers.md`
