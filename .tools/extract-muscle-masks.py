...
ANCHORS = [
    ...
    dict(key='biceps-left',          view='anterior',  svgX=110,  svgY=203, radius=24, colorThreshold=110, seedSearch=15),
    dict(key='biceps-right',         view='anterior',  svgX=255,  svgY=199, radius=24, colorThreshold=110, seedSearch=15),
    ...
    dict(key='abdominals',           view='anterior',  svgX=186,  svgY=221, radius=44, colorThreshold=130, seedSearch=15),
    ...
    dict(key='trapezius-left',       view='posterior', svgX=550,  svgY=113, radius=34, colorThreshold=110, seedSearch=20),
    dict(key='trapezius-right',      view='posterior', svgX=608,  svgY=127, radius=34, colorThreshold=140, seedSearch=25),
    dict(key='shoulders-back-left',  view='posterior', svgX=513,  svgY=122, radius=30, colorThreshold=150, seedSearch=30),
    dict(key='shoulders-back-right', view='posterior', svgX=629,  svgY=137, radius=30, colorThreshold=120, seedSearch=20),
    dict(key='lats-left',            view='posterior', svgX=488,  svgY=182, radius=42, colorThreshold=130, seedSearch=25),
    dict(key='lats-right',           view='posterior', svgX=619,  svgY=184, radius=42, colorThreshold=115, seedSearch=25),
    ...
    dict(key='gastrocnemius-left',   view='posterior', svgX=550,  svgY=468, radius=30, colorThreshold=110, seedSearch=25),
    dict(key='gastrocnemius-right',  view='posterior', svgX=603,  svgY=468, radius=30, colorThreshold=110, seedSearch=20),
]
