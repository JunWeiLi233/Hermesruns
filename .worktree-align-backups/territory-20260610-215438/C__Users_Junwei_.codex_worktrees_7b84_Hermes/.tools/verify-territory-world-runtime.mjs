...
function verifyNormalGlobalResponse(polygonsResult) {
  assert(
    String(polygonsResult.etag || "").includes("land-mask-union-v42-mask-v21-response-16m-real-user-global"),
    `Live backend did not serve the mask-v21 real-user global territory contract: ${polygonsResult.etag}`,
  );
