...
const TERRITORY_INTERACTIVE_RENDER_MAX_ACTIVE_POINTS_PER_OWNER = 9000;
...
const LAND_MASK_GLOBAL_ACTIVE_VISIBLE_REGIONS_PER_OWNER = 12;
      ...
      if (
        ...
        renderEntries.forEach(({ poly, tiles }, renderIndex) => {
          ...
          const regionOptions = {
            ...
            maxGroups: !selectedOwnerKeyValue && active
              ? LAND_MASK_GLOBAL_ACTIVE_VISIBLE_REGIONS_PER_OWNER
              : (useLocalViewportRegionBudget
                  ? LAND_MASK_MAX_LOCAL_VIEW_REGIONS_PER_OWNER
                  : LAND_MASK_MAX_VISIBLE_REGIONS_PER_OWNER),
          };
          const concreteLandRegionBudget = !selectedOwnerKeyValue && active
            ? LAND_MASK_GLOBAL_ACTIVE_VISIBLE_REGIONS_PER_OWNER
            : (useLocalViewportRegionBudget
                ? LAND_MASK_MAX_LOCAL_VIEW_REGIONS_PER_OWNER
                : LAND_MASK_MAX_VISIBLE_REGIONS_PER_OWNER);
