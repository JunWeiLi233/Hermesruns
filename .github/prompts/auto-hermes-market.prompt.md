...
4. Check [human loop state](../../.workspace/state/HUMAN_LOOP.md) and [agent sync](../../.workspace/state/AGENT_SYNC.md).
...
- Write the machine and human outputs under `.workspace/state/market/` as documented.
