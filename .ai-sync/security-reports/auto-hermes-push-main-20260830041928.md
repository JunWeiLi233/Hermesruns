...
Run Id: auto-hermes-push-main-20260830041928
Mode: audit
Status: completed
Generated: 2026-08-30T04:19:28.533Z
...
- [HIGH] idor-hunter :: Potential IDOR: Endpoint accesses resource by ID without verifying ownership.
  Target: DELETE /api/admin/audit/{id}
...
- [HIGH] idor-hunter :: Potential IDOR: Endpoint accesses resource by ID without verifying ownership.
  ...
  Verification: static-only
- [HIGH] idor-hunter :: Potential IDOR: Endpoint accesses resource by ID without verifying ownership.
  Target: POST /api/shoes/admin/{id}/search-images
  File: backend/src/main/java/com/hermes/backend/AdminShoeImageController.java
  Verification: static-only
- [HIGH] idor-hunter :: Potential IDOR: Endpoint accesses resource by ID without verifying ownership.
  Target: PUT /api/shoes/admin/{id}/photo
  File: backend/src/main/java/com/hermes/backend/AdminShoeImageController.java
  Verification: static-only
- [HIGH] idor-hunter :: Potential IDOR: Endpoint accesses resource by ID without verifying ownership.
  Target: PUT /api/shoes/admin/{id}/verify-photo
  File: backend/src/main/java/com/hermes/backend/AdminShoeImageController.java
  Verification: static-only
- [HIGH] idor-hunter :: Potential IDOR: Endpoint accesses resource by ID without verifying ownership.
  Target: PUT /api/shoes/admin/{id}/unverify-photo
  File: backend/src/main/java/com/hermes/backend/AdminShoeImageController.java
  Verification: static-only
- [HIGH] idor-hunter :: Potential IDOR: Endpoint accesses resource by ID without verifying ownership.
...
- [HIGH] rls-auditor :: Missing Row-Level Ownership: Potential for unauthorized data access.
  Target: activities
  File: backend/src/main/java/com/hermes/backend/Activity.java
  Verification: static-only
- [HIGH] rls-auditor :: Missing Row-Level Ownership: Potential for unauthorized data access.
...
- [HIGH] rls-auditor :: Missing Row-Level Ownership: Potential for unauthorized data access.
  ...
  File: backend/src/main/java/com/hermes/backend/billing/ProcessedStripeEvent.java
  Verification: static-only
...
- [LOW] leak-detector :: Endpoint shape suggests configuration, export, or status data that should be reviewed for oversharing.
  ...
  File: backend/src/main/java/com/hermes/backend/billing/BillingController.java
  Verification: static-only
