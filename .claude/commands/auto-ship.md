...
Workflow:
1. Run `& 'C:\Program Files\nodejs\node.exe' tools/optimize-agent-context.mjs --agent claude --tasks TASKS.md --guide CLAUDE.md --queue-mode first --write` and read `.workspace/codex/optimized-claude.md`.
