...
1. Read `.workspace/codex/optimized-claude.md` first (generated at session start) for queue status. Fall back to TASKS.md directly if missing.
1a. Read `.workspace/state/AGENT_SYNC.md` and `.workspace/state/HUMAN_LOOP.md` before self-generated rounds.
