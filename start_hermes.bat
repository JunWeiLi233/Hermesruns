...
echo [Hermes] (run stop_hermes.cmd there), or set HERMES_ALLOW_CROSS_TREE_START=1.
echo ==========================================================
...
echo [Hermes]   (a) run stop_hermes.cmd from the other tree - a clean handover
