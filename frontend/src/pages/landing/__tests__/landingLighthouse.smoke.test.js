...
const dashboardSource = readFileSync(path.join(here, "../../admin/Dashboard.jsx"), 'utf8');
...
const securityHeadersSource = readFileSync(
  path.join(repoRoot, 'backend/src/main/java/com/hermes/backend/auth/SecurityHeadersFilter.java'),
  'utf8',
);
