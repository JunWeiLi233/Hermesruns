...
assert.equal(existsSync(path.join(here, '../../../assets/generated/prediction-10k-hero-1600.webp')), false, 'The byte-identical full-size WebP copy should not be retained.');
assert.match(pageSource, /\$\{predictionTenKHeroImage\} 1600w/, 'The largest responsive WebP should reuse the fallback image at its existing width.');
assert.match(
  pageSource,
