...
const auditControllerSource = readFileSync(
  path.join(here, '../../../backend/src/main/java/com/hermes/backend/AdminAuditPortalController.java'),
  'utf8',
);
const auditServiceSource = readFileSync(
  path.join(here, '../../../backend/src/main/java/com/hermes/backend/AdminPortalService.java'),
  'utf8',
);
const auditEntitySource = readFileSync(
  path.join(here, '../../../backend/src/main/java/com/hermes/backend/AdminAuditLog.java'),
  'utf8',
);
