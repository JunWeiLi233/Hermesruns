...
const REFERENCE_BODY_MEASURE_REGIONS = [
  ...
  },
  {
    ...
    posteriorAlignmentTransform: POSTERIOR_LEG_REGION_ALIGNMENT_TRANSFORM,
    paths: [
      'M528 479 C540 491 541 517 535 541 C530 551 523 554 517 545 C514 521 516 495 522 481 Z',
      'M565 479 C556 491 555 517 561 541 C566 551 573 554 579 545 C581 521 579 495 574 481 Z',
    ],
    highlightPaths: [
      'M524 487 C535 499 536 519 531 539 C527 547 522 549 518 542 C516 521 518 499 524 487 Z',
      'M568 487 C558 499 557 519 562 539 C566 547 571 549 575 542 C577 521 575 499 568 487 Z',
    ],
    fibers: [
      'M526 485 C532 501 532 523 526 544',
      'M537 487 C540 506 539 526 533 545',
      'M563 487 C560 506 561 526 567 545',
      'M573 485 C568 501 568 523 574 544',
    ],
    markers: [
      { cx: 528, cy: 503, rx: 4, ry: 4 },
      { cx: 532, cy: 533, rx: 4, ry: 4 },
      { cx: 566, cy: 503, rx: 4, ry: 4 },
      { cx: 570, cy: 533, rx: 4, ry: 4 },
    ],
  },
];
