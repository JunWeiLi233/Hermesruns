...
const landingSource = fs.readFileSync(new URL('./Landing.jsx', import.meta.url), 'utf8');
const legalSource = fs.readFileSync(new URL('./LegalPage.jsx', import.meta.url), 'utf8');
