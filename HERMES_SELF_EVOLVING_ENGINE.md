...
- Trace-to-skill is now the live repo-side workflow-learning layer: `tools/auto-hermes-trace-to-skill.mjs` refreshes `.workspace/state/AUTO_HERMES_TRACE_TO_SKILL.{json,md}` plus the advisory repo-local skill `.codex/skills/auto-hermes-evolved/SKILL.md`.
